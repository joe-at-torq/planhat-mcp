...
if (!apiToken) {
    process.stderr.write("Error: PLANHAT_API_TOKEN environment variable is required.\n" +
...
const server = new Server({ name: "planhat-mcp", version: "1.0.0" }, { capabilities: { tools: {} } });
