...
add({
    ...
    description: "Get a lightweight list of companies with only _id, name, externalId, and sourceId. Auto-paginates to return all matches. Pass 'limit' to cap results.",
    inputSchema: {
        type: "object",
        properties: {
